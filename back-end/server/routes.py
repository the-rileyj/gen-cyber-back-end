...
def both_hello():
    def handle_both_hello(name="world"):
        """ Handles saying hello

        POST - .*/<str:name> - JSON payload = {
    ...
    return handle_both_hello


def get_hello():
    def handle_get_hello(name="world"):
        """ Handles saying hello
    ...
    return handle_get_hello


def post_hello():
    def handle_post_hello(name="world"):
        """ Handles saying hello
